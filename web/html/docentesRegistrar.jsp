<%-- 
    Document   : docentesRegistrar
    Created on : 14/04/2021, 02:21:16 PM
    Author     : pc
--%>
...
<html>
    <head>
        ...
        <link  rel="stylesheet" type="text/css" href="css/registroAlumno.css">
        <script>
    ...
    <body>
        ...
        --%>
            <section id="contenido"><br><br>
                    ...
                    <article>
                        <center>
                            <h2 id="regi">Registrar Docente</h2>
                            <table id="tabla1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="fname" name="T" maxlength="10" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr><td><input type="text" id="fname" name="AM" required></td>
                                    <td><input type="text" id="fname" name="E"  pattern="^[^@]+@[^@]+\.[a-zA-Z]{2,}$" placeholder="Correo Institucional" required> </td>
                                </tr>                       
                                <tr>
