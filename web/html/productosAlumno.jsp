<%-- 
    Document   : productosAlumno
    Created on : 14/04/2021, 02:15:15 PM
    Author     : pc
--%>
...
[2:15 p. m., 14/4/2021] Beca Crush ❤️: <%@page import="java.util.ArrayList"%>
<%@page import="mx.com.system.modelo.beans.Planes_Est"%>
<%@page import="java.util.Iterator"%>
<%@page import="mx.com.system.modelo.beans.Divisiones"%>
<%@page import="mx.com.system.modelo.beans.Convocatoriass"%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link  rel="stylesheet" type="text/css" href="css/cssConvocatorias.css">
    </head>
    <body>
        <%--
            HttpSession sesion = request.getSession();
